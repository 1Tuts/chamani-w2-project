$(function () { /* /////////////////////////////////// Start Top jq /////////////////////////////////// */
    ...
    $(".fa ,.en ,.about").mouseover(function () {
        ...
        top.find('p#' + $(this).attr("class")).stop().animate({
            'opacity': '1'
        }, 800);
    });
    ...
    start_intro.click(function () {
        ...
        overlay.stop().animate({
            ...
            video.stop().animate({
                ...
                video.find('#videoContent').css({
                    'display': 'block'
                });
                video.find('#videoContent').stop().animate({
                    'opacity': '1'
                }, 700, null, function () {
                    close_video.css({
                        'display': 'block'
    ...
    $(document).keydown(function (e) {
        ((e.keyCode ? e.keyCode : e.which) == "27") &&
        hideWin();
    });
    ...
    $("#home-btn,#product-btn,#gallery-btn,#contactus-btn").click(function () {
        switch ($(this).attr("id")) {
        case 'home-btn':
            $(".scroll .home_main").slideto({
                highlight: false,
                slide_duration: 2000
            });
            break;
        case 'product-btn':
            $(".scroll .product_main").slideto({
                highlight: false,
                slide_duration: 2000
            });
            break;
        case 'gallery-btn':
            $(".scroll .gallery_main").slideto({
                highlight: false,
                slide_duration: 2000
            });
            break;
        default:
            $(".scroll .contactus_main").slideto({
                highlight: false,
                slide_duration: 2000
            });
        }

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url') ?>/style-intro.css">
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url') ?>/style-page.css">
	<!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url') ?>/stupid-ie.css"><![endif]-->
		...
		<div class="loading">
			<div class="swf">
				<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="280" height="60">
	  				<param name=movie value="<?php bloginfo('template_url') ?>/swf/loading.swf" />
	  				<param name="wmode" value="transparent" />
	  				<param name="play" VALUE="true" />
	  				<param name="loop" VALUE="true" />
	  				<param name="menu" value="false" />
	  				<param name="quality" value="best" />
	  				<embed src="<?php bloginfo('template_url') ?>/swf/loading.swf" quality="best" wmode="transparent" menu="false" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="280" height="60">
	  				</embed>
				</object>
			</div>
			<p>L o a d i n g . . .</p>
